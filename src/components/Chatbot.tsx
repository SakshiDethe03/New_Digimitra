...
export const Chatbot = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      text:
        language === "en"
          ? "Hello! I'm your DigiMitra assistant. How can I help you today?"
          : "नमस्कार! मी तुमचा DigiMitra सहाय्यक आहे. मी तुम्हाला कशी मदत करू शकतो?",
      isBot: true,
  ...
  const handleSend = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("DigiMitra Chatbot Error:", error);
        ...
        ...prev,
        {
          text:
            language === "en"
              ...
              : "क्षमस्व, मला सध्या कनेक्ट होण्यात अडचण येत आहे. कृपया पुन्हा प्रयत्न करा.",
          isBot: true,
          time: new Date().toLocaleTimeString([], {
            hour: "2-digit",
            minute: "2-digit",
            ...
            >
              {messages.map((msg, i) => (
                ...
                >
                  <div
                    className={cn(
                      "px-4 py-3 rounded-2xl text-sm shadow-sm leading-relaxed whitespace-pre-wrap break-words",
                      msg.isBot
              ...
              {isLoading && (
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="flex flex-col self-start max-w-[90%]"
                >
                  <div className="px-4 py-3 bg-card border border-border rounded-2xl rounded-tl-none shadow-sm flex items-center gap-1.5">
